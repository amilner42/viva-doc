...
export class JavaParser extends Parser {
	...
	public program(): ProgramContext {
		...
		this.enterRule(_localctx, 0, JavaParser.RULE_program);
		let _la: number;
		try {
			...
			if (_la === JavaParser.MultiLineComment || _la === JavaParser.SingleLineComment) {
				{
				this.state = 10;
				this.sourceElements();
				}
	...
	public sourceElements(): SourceElementsContext {
		...
		this.enterRule(_localctx, 2, JavaParser.RULE_sourceElements);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			...
			do {
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
			} while (_la === JavaParser.MultiLineComment || _la === JavaParser.SingleLineComment);
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public sourceElement(): SourceElementContext {
		...
		this.enterRule(_localctx, 4, JavaParser.RULE_sourceElement);
		try {
			this.state = 22;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
			case JavaParser.MultiLineComment:
				this.enterOuterAlt(_localctx, 1);
				{
				this.state = 20;
				...
				break;
			case JavaParser.SingleLineComment:
	...
	public multiLineComment(): MultiLineCommentContext {
		...
		this.enterRule(_localctx, 6, JavaParser.RULE_multiLineComment);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 24;
			this.match(JavaParser.MultiLineComment);
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public singleLineComment(): SingleLineCommentContext {
		...
		this.enterRule(_localctx, 8, JavaParser.RULE_singleLineComment);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 26;
			this.match(JavaParser.SingleLineComment);
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
...
export class ProgramContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return JavaParser.RULE_program; }
	// @Override
...
export class SourceElementsContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return JavaParser.RULE_sourceElements; }
	// @Override
	public enterRule(listener: JavaParserListener): void {
...
export class SourceElementContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return JavaParser.RULE_sourceElement; }
	// @Override
	public enterRule(listener: JavaParserListener): void {
...
export class MultiLineCommentContext extends ParserRuleContext {
	public MultiLineComment(): TerminalNode { return this.getToken(JavaParser.MultiLineComment, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return JavaParser.RULE_multiLineComment; }
	// @Override
	public enterRule(listener: JavaParserListener): void {
...
export class SingleLineCommentContext extends ParserRuleContext {
	public SingleLineComment(): TerminalNode { return this.getToken(JavaParser.SingleLineComment, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return JavaParser.RULE_singleLineComment; }
	// @Override
	public enterRule(listener: JavaParserListener): void {
