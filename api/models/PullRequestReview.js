...
const PullRequestReviewSchema = new mongoose.Schema({
  ...
  headCommitUserAssessments: { type: [ { _id: false, username: String, tagId: String, assessmentType: String } ], required: [true, "can't be blank"] },
  headCommitTagsOwnerGroups: { type: [ { _id: false, tagId: String, groups: [ [ String ] ] } ], required: [true, "can't be blank"] },
